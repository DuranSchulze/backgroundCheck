...
export default async function OrderDetailPage({
  ...
  return (
    <AdminShell
      ...
      title={`Order ${detail.order.trackingNumber}`}
      description="Review intake data and manage the requested service checks for this background-check order. Task execution now lives inside each service check detail view."
    >
      <div>
        <Link
          href="/admin/orders"
        ...
        <div className="mt-4">
          ...
          <h1 className="mt-1 font-headline text-3xl font-extrabold text-on-surface md:text-[2.25rem]">
        ...
        <section>
          <div className="rounded-lg border border-outline-variant/20 bg-white p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-on-surface-variant">
              Manage the status and notes for each service check on this order.
            </p>
            <ServiceCheckList
